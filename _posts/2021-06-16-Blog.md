...
<img src="https://github.com/xj731231/xj731231.github.io/tree/master/img/2021-06-16-Blog/jdbc的本质与结构.jpg" alt=" JDBC Driver Manager -- JDBC Driver -- DataBase" style="zoom:67%;" />
...
<img src="img/2021-06-16-Blog/jdbc运行流程.jpg" alt="步骤：导入驱动包（mysql，oracle，sybase……），装载数据库驱动程序；连接数据库；获取可执行sql语句的对象，执行sql语句；关闭连接" style="zoom:67%;" />
